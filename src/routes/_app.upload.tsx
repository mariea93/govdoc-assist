  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Upload PDF, DOCX or TXT files for AI summarization and translation.</p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-5">
            <div>
              ...
              <RadioGroup value={action} onValueChange={setAction} className="mt-2 grid gap-2">
                {[
                  ...
                  <label key={o.v} className="flex cursor-pointer items-center gap-2 rounded-md border p-3 text-sm hover:bg-muted/50">
            ...
            <div>
              ...
              <RadioGroup value={length} onValueChange={setLength} className="mt-2 grid grid-cols-3 gap-2">
                {["short", "medium", "detailed"].map((l) => (
                  <label key={l} className="flex cursor-pointer items-center justify-center gap-2 rounded-md border p-2 text-sm capitalize hover:bg-muted/50">
