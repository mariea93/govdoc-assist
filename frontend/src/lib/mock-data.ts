...
export const users = [
  { id: 1, name: "Jean Bosco Habimana", email: "admin@gov.rw", role: "Admin", office: "MINALOC HQ", status: "Active" },
  { id: 2, name: "Uwase Mukamana", email: "uwase.m@kigali.gov.rw", role: "User", office: "Kigali District", status: "Active" },
  { id: 3, name: "Claude Niyonzima", email: "claude.n@gov.rw", role: "User", office: "Musanze District", status: "Active" },
  { id: 4, name: "Aline Ingabire", email: "user@gov.rw", role: "User", office: "Huye Sector", status: "Active" },
  { id: 5, name: "Eric Mugisha", email: "eric.m@gov.rw", role: "User", office: "Rubavu District", status: "Disabled" },
];
